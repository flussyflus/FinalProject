		...
		<nav class="navbar navbar-default" role="navigation">
			<div class="container-fluid">
				<ul class="nav navbar-nav navbar navbar-left">
						...
						<li><a href="" id="admittanceData" data-toggle="tab">Admittances\discharges</a></li>
				  ...
				  <div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="">
								<form class="" id="addUserForm" style="font-size:15px;">
									...
									<div class="form-group">
										...
										<input type="password" id="regPassword" name="regPassword" class="form-control password" placeholder="Password" required>
									</div>
									<div class="form-group">
										<label>Confirm Password</label>
										<input type="password" id="password-confirm" class="form-control password" placeholder="Confirm Password" required>
									</div>
									<div class="form-group">
										<label>User Type</label><br>
										<select id="selectTypeReg" class="form-control">
											<option selected="selected" id="cleaner" value="cleaner">Cleaner</option>
											<option id="administrator" value="administrator">Administrator</option>
											<option id="administration" value="administration">Administration</option>
											<option id="triage" value="triage">Triage Nurse</option>
										</select>
									</div>
									<div class="form-group">
										<label>First Name</label>
										<input type="text" name="regFirst_name" id="regFirst_name" class="form-control" placeholder="First Name" required>
									</div>
									<div class="form-group">
										<label>Last Name</label>
										<input type="text" name="regLast_name" id="regLast_name" class="form-control" placeholder="Last Name" required>
									</div>
									<div class="form-group">
										<label>Address</label>
